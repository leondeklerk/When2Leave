...
public class W2lFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.date:
                datePicker = new DatePickerDialog(getContext(), pickerTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                break;
            case R.id.time:
                timePicker = new TimePickerDialog(getContext(), pickerTheme, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                break;
            case R.id.hour:
                builderHour = new AlertDialog.Builder(getContext(), alertTheme);
                if(switch_state){
                    builderHour.setTitle(getString(R.string.hour_fill_in));
                    builderHour.setView(layout);
                    builderHour.setPositiveButton(R.string.dialog_confirm, new DialogInterface.OnClickListener() {
                    ...
                    builderHour.setNegativeButton(R.string.dialog_cancel, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                        }
                    });
                    ...
                    builderHour.setTitle(getString(R.string.hour_select)).setItems(arrayHour, new DialogInterface.OnClickListener() {
                        @Override
                ...
                break;
            case R.id.minute:
                builderMinute = new AlertDialog.Builder(getContext(), alertTheme);
                if(switch_state){
                    builderMinute.setTitle(getString(R.string.minute_fill_in));
                    builderMinute.setView(layout);
                    builderMinute.setPositiveButton(R.string.dialog_confirm, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            Editable input = etDialog.getText();
                    ...
                    builderMinute.setNegativeButton(R.string.dialog_cancel, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                        }
                    });
                    ...
                    builderMinute.setTitle(getString(R.string.minute_select)).setItems(arrayMinute, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int selected) {
            ...
            case R.id.calc:
                ...
                alertBuilder.setMessage(result).setPositiveButton(R.string.dialog_confirm, new DialogInterface.OnClickListener()  {
                    public void onClick(DialogInterface dialog, int id) {
                    }
                });

                if(notification) {
                    alertBuilder.setNeutralButton(R.string.set_notification, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if((int)cInput.getTimeInMillis() <= Integer.MAX_VALUE) {
                                value = (int) cInput.getTimeInMillis();

                                millisValue = cInput.getTimeInMillis();

                            } else {
                                value = (int) (cInput.getTimeInMillis()) / 10;
                            }
                            ...
                            if(!created) {
                                ...
                                set = preferences.getStringSet("notification_array", setTest);
                                set.add(Integer.toString(value) + Long.toString(millisValue));
                                ...
                                PendingIntent pendingIntent = PendingIntent.getBroadcast(getContext(), value, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
